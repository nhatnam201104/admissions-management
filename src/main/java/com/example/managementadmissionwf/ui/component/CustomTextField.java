...
/**
 * CustomTextField - A modern text field with rounded border
...
public class CustomTextField extends JTextField {
    ...
    /**
     * Configure the text field with modern styling
     */
    private void customizeTextField() {
        ...
        setMinimumSize(new Dimension(400, UIConstants.TEXT_FIELD_HEIGHT));
