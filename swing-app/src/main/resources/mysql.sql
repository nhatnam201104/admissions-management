...
CREATE TABLE `xt_bangquydoi` (
  ...
  `d_phuongthuc` varchar(50) NOT NULL,
  `d_tohop` varchar(10) DEFAULT NULL,
  `d_mon` varchar(10) NOT NULL,
  `d_diema` decimal(6,2) NOT NULL,
  `d_diemb` decimal(6,2) NOT NULL,
  `d_diemc` decimal(6,2) NOT NULL,
...
CREATE TABLE `xt_diemthixettuyen` (
  ...
  UNIQUE KEY `sobaodanh_UNIQUE` (`sobaodanh`),
...
CREATE TABLE `xt_nguyenvongxettuyen` (
  ...
  `nv_manganh` varchar(50) NOT NULL,
  `nv_tt` int NOT NULL,
  `diem_thxt` decimal(10,5) DEFAULT NULL COMMENT 'đã cộng điểm môn chính',
  `diem_utqd` decimal(10,5) DEFAULT NULL COMMENT 'Điểm UTQD theo tổ hợp sẽ khác nhau.',
  ...
  `nv_ketqua` varchar(20) DEFAULT NULL,
